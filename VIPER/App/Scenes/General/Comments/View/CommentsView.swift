...
class CommentsView: UIViewController {
    ...
    override func didReceiveMemoryWarning() {
        debugPrint("COMMENT VIEW: LA APLICACION SE ESTA QUEDANDO SIN MEMORIA...")
    }
...
extension CommentsView: UITableViewDataSource {
     ...
     */
    private func updateAction(comment: CommentViewData, indexPath: IndexPath) {
     ...
     */
    private func deleteAction(comment: CommentViewData, indexPath: IndexPath) {
...
extension CommentsView: PostCommentsListTableViewCellProtocol {
    func didTapLikeButton(comment: CommentViewData) {
        print("like")
        print(comment)
        // LLAMAR AL PRESENTER
